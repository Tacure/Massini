...
using static Massini.Flamet.ApiConstants;

namespace Massini.Flamet.Classes
{
    public unsafe partial class Texture : IResource, IDisposable
    {
        public TextureFormat Format => IntSharedCvs.VkFormatToTextureFormat(m_format);
        ...
        public TextureType Type => IntSharedCvs.VkImageTypeToTextureType(m_imageType);
        ...
        public Texture(Device i_device, in TextureCreateParams i_createParams)
        {
            ...
            IntSharedFuncs.SetObjectLabel(i_device, image, VkObjectType.VK_OBJECT_TYPE_IMAGE, $"{i_createParams.p_type} - {i_createParams.p_label}");
