...
namespace Massini.Bindings.Vulkan
{
    public static unsafe partial class Vk
    {
        ...
        public static extern delegate* unmanaged[Cdecl]<void> vkGetInstanceProcAddr([NativeTypeName("VkInstance")] VkInstance_T* instance, [NativeTypeName("const char *")] sbyte* pName);

        [DllImport("vulkan", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("PFN_vkVoidFunction")]
        public static extern delegate* unmanaged[Cdecl]<void> vkGetDeviceProcAddr([NativeTypeName("VkDevice")] VkDevice_T* device, [NativeTypeName("const char *")] sbyte* pName);
        ...
        public static extern uint vkGetPhysicalDeviceWaylandPresentationSupportKHR([NativeTypeName("VkPhysicalDevice")] VkPhysicalDevice_T* physicalDevice, [NativeTypeName("uint32_t")] uint queueFamilyIndex, [NativeTypeName("struct wl_display *")] wl_display* display);
        ...
        [DllImport("vulkan", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("VkBool32")]
        public static extern uint vkGetPhysicalDeviceXlibPresentationSupportKHR([NativeTypeName("VkPhysicalDevice")] VkPhysicalDevice_T* physicalDevice, [NativeTypeName("uint32_t")] uint queueFamilyIndex, [NativeTypeName("Display *")] _XDisplay* dpy, [NativeTypeName("VisualID")] nuint visualID);
        ...
        [NativeTypeName("#define VK_HEADER_VERSION 341")]
        public const int VK_HEADER_VERSION = 341;

        [NativeTypeName("#define VK_HEADER_VERSION_COMPLETE VK_MAKE_API_VERSION(0, 1, 4, VK_HEADER_VERSION)")]
        public const uint VK_HEADER_VERSION_COMPLETE = ((((uint)(0)) << 29) | (((uint)(1)) << 22) | (((uint)(4)) << 12) | ((uint)(341)));
        ...
        [NativeTypeName("#define VK_KHR_internally_synchronized_queues 1")]
        public const int VK_KHR_internally_synchronized_queues = 1;

        [NativeTypeName("#define VK_KHR_INTERNALLY_SYNCHRONIZED_QUEUES_SPEC_VERSION 1")]
        public const int VK_KHR_INTERNALLY_SYNCHRONIZED_QUEUES_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_KHR_INTERNALLY_SYNCHRONIZED_QUEUES_EXTENSION_NAME \"VK_KHR_internally_synchronized_queues\"")]
        public static ReadOnlySpan<byte> VK_KHR_INTERNALLY_SYNCHRONIZED_QUEUES_EXTENSION_NAME => "VK_KHR_internally_synchronized_queues"u8;
        ...
        public const int VULKAN_VIDEO_CODEC_AV1STD_DECODE_H_ = 1;
        ...
        public const int VULKAN_VIDEO_CODEC_AV1STD_ENCODE_H_ = 1;
        ...
        public const int VULKAN_VIDEO_CODEC_VP9STD_H_ = 1;
        ...
        public const int VULKAN_VIDEO_CODEC_VP9STD_DECODE_H_ = 1;
        ...
        [NativeTypeName("#define VK_KHR_shader_fma 1")]
        public const int VK_KHR_shader_fma = 1;

        [NativeTypeName("#define VK_KHR_SHADER_FMA_SPEC_VERSION 1")]
        public const int VK_KHR_SHADER_FMA_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_KHR_SHADER_FMA_EXTENSION_NAME \"VK_KHR_shader_fma\"")]
        public static ReadOnlySpan<byte> VK_KHR_SHADER_FMA_EXTENSION_NAME => "VK_KHR_shader_fma"u8;
        ...
        [NativeTypeName("#define VK_KHR_maintenance10 1")]
        public const int VK_KHR_maintenance10 = 1;

        [NativeTypeName("#define VK_KHR_MAINTENANCE_10_SPEC_VERSION 1")]
        public const int VK_KHR_MAINTENANCE_10_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_KHR_MAINTENANCE_10_EXTENSION_NAME \"VK_KHR_maintenance10\"")]
        ...
        [NativeTypeName("#define VK_NVX_IMAGE_VIEW_HANDLE_SPEC_VERSION 4")]
        public const int VK_NVX_IMAGE_VIEW_HANDLE_SPEC_VERSION = 4;
        ...
        [NativeTypeName("#define VK_EXT_descriptor_heap 1")]
        public const int VK_EXT_descriptor_heap = 1;

        [NativeTypeName("#define VK_EXT_DESCRIPTOR_HEAP_SPEC_VERSION 1")]
        public const int VK_EXT_DESCRIPTOR_HEAP_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME \"VK_EXT_descriptor_heap\"")]
        public static ReadOnlySpan<byte> VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME => "VK_EXT_descriptor_heap"u8;
        ...
        [NativeTypeName("#define VK_EXT_present_timing 1")]
        public const int VK_EXT_present_timing = 1;

        [NativeTypeName("#define VK_EXT_PRESENT_TIMING_SPEC_VERSION 3")]
        public const int VK_EXT_PRESENT_TIMING_SPEC_VERSION = 3;

        [NativeTypeName("#define VK_EXT_PRESENT_TIMING_EXTENSION_NAME \"VK_EXT_present_timing\"")]
        public static ReadOnlySpan<byte> VK_EXT_PRESENT_TIMING_EXTENSION_NAME => "VK_EXT_present_timing"u8;
        ...
        [NativeTypeName("#define VK_EXT_FRAGMENT_DENSITY_MAP_SPEC_VERSION 3")]
        public const int VK_EXT_FRAGMENT_DENSITY_MAP_SPEC_VERSION = 3;
        ...
        [NativeTypeName("#define VK_EXT_texture_compression_astc_3d 1")]
        public const int VK_EXT_texture_compression_astc_3d = 1;

        [NativeTypeName("#define VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_SPEC_VERSION 1")]
        public const int VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_EXTENSION_NAME \"VK_EXT_texture_compression_astc_3d\"")]
        public static ReadOnlySpan<byte> VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_EXTENSION_NAME => "VK_EXT_texture_compression_astc_3d"u8;
        ...
        [NativeTypeName("#define VK_EXT_memory_decompression 1")]
        public const int VK_EXT_memory_decompression = 1;

        [NativeTypeName("#define VK_EXT_MEMORY_DECOMPRESSION_SPEC_VERSION 1")]
        public const int VK_EXT_MEMORY_DECOMPRESSION_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_MEMORY_DECOMPRESSION_EXTENSION_NAME \"VK_EXT_memory_decompression\"")]
        public static ReadOnlySpan<byte> VK_EXT_MEMORY_DECOMPRESSION_EXTENSION_NAME => "VK_EXT_memory_decompression"u8;
        ...
        [NativeTypeName("#define VK_NV_push_constant_bank 1")]
        public const int VK_NV_push_constant_bank = 1;

        [NativeTypeName("#define VK_NV_PUSH_CONSTANT_BANK_SPEC_VERSION 1")]
        public const int VK_NV_PUSH_CONSTANT_BANK_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_NV_PUSH_CONSTANT_BANK_EXTENSION_NAME \"VK_NV_push_constant_bank\"")]
        public static ReadOnlySpan<byte> VK_NV_PUSH_CONSTANT_BANK_EXTENSION_NAME => "VK_NV_push_constant_bank"u8;

        [NativeTypeName("#define VK_EXT_ray_tracing_invocation_reorder 1")]
        public const int VK_EXT_ray_tracing_invocation_reorder = 1;

        [NativeTypeName("#define VK_EXT_RAY_TRACING_INVOCATION_REORDER_SPEC_VERSION 1")]
        public const int VK_EXT_RAY_TRACING_INVOCATION_REORDER_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME \"VK_EXT_ray_tracing_invocation_reorder\"")]
        public static ReadOnlySpan<byte> VK_EXT_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME => "VK_EXT_ray_tracing_invocation_reorder"u8;
        ...
        [NativeTypeName("#define VK_ARM_performance_counters_by_region 1")]
        public const int VK_ARM_performance_counters_by_region = 1;

        [NativeTypeName("#define VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_SPEC_VERSION 1")]
        public const int VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_EXTENSION_NAME \"VK_ARM_performance_counters_by_region\"")]
        public static ReadOnlySpan<byte> VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_EXTENSION_NAME => "VK_ARM_performance_counters_by_region"u8;
        ...
        [NativeTypeName("#define VK_EXT_shader_64bit_indexing 1")]
        public const int VK_EXT_shader_64bit_indexing = 1;

        [NativeTypeName("#define VK_EXT_SHADER_64BIT_INDEXING_SPEC_VERSION 1")]
        public const int VK_EXT_SHADER_64BIT_INDEXING_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_SHADER_64BIT_INDEXING_EXTENSION_NAME \"VK_EXT_shader_64bit_indexing\"")]
        public static ReadOnlySpan<byte> VK_EXT_SHADER_64BIT_INDEXING_EXTENSION_NAME => "VK_EXT_shader_64bit_indexing"u8;

        [NativeTypeName("#define VK_EXT_custom_resolve 1")]
        public const int VK_EXT_custom_resolve = 1;

        [NativeTypeName("#define VK_EXT_CUSTOM_RESOLVE_SPEC_VERSION 1")]
        public const int VK_EXT_CUSTOM_RESOLVE_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_CUSTOM_RESOLVE_EXTENSION_NAME \"VK_EXT_custom_resolve\"")]
        public static ReadOnlySpan<byte> VK_EXT_CUSTOM_RESOLVE_EXTENSION_NAME => "VK_EXT_custom_resolve"u8;

        [NativeTypeName("#define VK_QCOM_data_graph_model 1")]
        public const int VK_QCOM_data_graph_model = 1;

        [NativeTypeName("#define VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM 3U")]
        public const uint VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM = 3U;

        [NativeTypeName("#define VK_QCOM_DATA_GRAPH_MODEL_SPEC_VERSION 1")]
        public const int VK_QCOM_DATA_GRAPH_MODEL_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_QCOM_DATA_GRAPH_MODEL_EXTENSION_NAME \"VK_QCOM_data_graph_model\"")]
        public static ReadOnlySpan<byte> VK_QCOM_DATA_GRAPH_MODEL_EXTENSION_NAME => "VK_QCOM_data_graph_model"u8;

        [NativeTypeName("#define VK_EXT_shader_long_vector 1")]
        public const int VK_EXT_shader_long_vector = 1;

        [NativeTypeName("#define VK_EXT_SHADER_LONG_VECTOR_SPEC_VERSION 1")]
        public const int VK_EXT_SHADER_LONG_VECTOR_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_SHADER_LONG_VECTOR_EXTENSION_NAME \"VK_EXT_shader_long_vector\"")]
        public static ReadOnlySpan<byte> VK_EXT_SHADER_LONG_VECTOR_EXTENSION_NAME => "VK_EXT_shader_long_vector"u8;
        ...
        [NativeTypeName("#define VK_EXT_shader_uniform_buffer_unsized_array 1")]
        public const int VK_EXT_shader_uniform_buffer_unsized_array = 1;

        [NativeTypeName("#define VK_EXT_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_SPEC_VERSION 1")]
        public const int VK_EXT_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_EXTENSION_NAME \"VK_EXT_shader_uniform_buffer_unsized_array\"")]
        public static ReadOnlySpan<byte> VK_EXT_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_EXTENSION_NAME => "VK_EXT_shader_uniform_buffer_unsized_array"u8;

        [NativeTypeName("#define VK_NV_compute_occupancy_priority 1")]
        public const int VK_NV_compute_occupancy_priority = 1;

        [NativeTypeName("#define VK_NV_COMPUTE_OCCUPANCY_PRIORITY_SPEC_VERSION 1")]
        public const int VK_NV_COMPUTE_OCCUPANCY_PRIORITY_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_NV_COMPUTE_OCCUPANCY_PRIORITY_EXTENSION_NAME \"VK_NV_compute_occupancy_priority\"")]
        public static ReadOnlySpan<byte> VK_NV_COMPUTE_OCCUPANCY_PRIORITY_EXTENSION_NAME => "VK_NV_compute_occupancy_priority"u8;

        [NativeTypeName("#define VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV 0.25f")]
        public const float VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV = 0.25f;

        [NativeTypeName("#define VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV 0.50f")]
        public const float VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV = 0.50f;

        [NativeTypeName("#define VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV 0.75f")]
        public const float VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV = 0.75f;

        [NativeTypeName("#define VK_EXT_shader_subgroup_partitioned 1")]
        public const int VK_EXT_shader_subgroup_partitioned = 1;

        [NativeTypeName("#define VK_EXT_SHADER_SUBGROUP_PARTITIONED_SPEC_VERSION 1")]
        public const int VK_EXT_SHADER_SUBGROUP_PARTITIONED_SPEC_VERSION = 1;

        [NativeTypeName("#define VK_EXT_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME \"VK_EXT_shader_subgroup_partitioned\"")]
        ...
        [NativeTypeName("#define VULKAN_WAYLAND_H_ 1")]
        public const int VULKAN_WAYLAND_H_ = 1;
        ...
        [NativeTypeName("#define VULKAN_XLIB_H_ 1")]
        public const int VULKAN_XLIB_H_ = 1;
